...
class ProfileSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Profile::create([
            ...
            'bio' => "I'm a Full-Stack Laravel Developer with experience building secure, scalable, and maintainable web applications using Laravel, PHP, MySQL, and modern web technologies. I'm skilled in RESTful API development, authentication, role-based access control, database design, and admin panel development with Filament. Currently expanding my expertise in Docker, Redis, Linux server administration, and VPS deployment to build production-ready applications following modern DevOps practices.",
            ...
            'current_focus' => 'Currently focused on mastering Laravel advanced features, Redis caching, Docker containerization, Linux server administration, VPS deployment, and building RESTful APIs with Sanctum authentication.',
